...
const PieCharts = () => {
    return (
        <div className='box-shadow dark:shadow-none text-gray-500 dark:bg-gray-800 dark:text-white mx-auto'>
            ...
            <div className='flex justify-between items-center mt-8 text-sm mx-8'>
                <div>
                    Target
